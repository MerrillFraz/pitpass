...
export type CreateTripStopInput = z.infer<typeof createTripStopSchema.shape.body>;
export type UpdateTripStopInput = z.infer<typeof updateTripStopSchema.shape.body>;
