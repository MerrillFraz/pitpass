...
export type CreateExpenseInput = z.infer<typeof createExpenseSchema.shape.body>;
export type UpdateExpenseInput = z.infer<typeof updateExpenseSchema.shape.body>;
